...
def show_info():
    messagebox.showinfo('Информация о программе',
                        ...
                        'Для отсечения многоугольника произвольным выпуклым отсекателем используется алгоритм Сазерленда-Ходжмена.\n'
                        '========Инструкции для пользователя:========\n'
                        'С помощью левой кнопки мыши мы добавляем вершину отсекателя.\n'
                        'С помощью правой кнопки мыши - добавляем вершины фигуру.')
